...
users = ['jaya', 'ruchi', 'anu']
pins = ['1111', '2222', '3333']
amounts = [1000, 2000, 3000]
count = 0
#welcomeing the user to the atm
print('-----------------------------------')
print('***********************************')
print('---WELCOME TO THE TCS BANK"s ATM---')
print("-----**********************--------")
print('----********THARUN********---------')
print("-----*****CHAMPSTAR*******---------")
print('-----********BANK**********--------')
print("-----**************************-----")
print('!!!PLEASE ENTER YOUR USER BELLOW!!!')
print('***********************************')
print('-----------------------------------')
...
while True:
	user = input('\nENTER USER NAME: ')
	print('*****************************************')
	print("---WELCOME TO THE TCS's BANKING SYSTEM---")
	user = user.lower()
	if user in users:
		if user == users[0]:
			n = 0
...
print('--------------------------')
print('**************************')	
print(str.capitalize(users[n]), 'welcome to TCS ATM')
print('**************************')
print('--------TCS ATM SYSTEM-----------')
# Main menu
while True:
	#os.system('clear')
	print('-------------------------------')
